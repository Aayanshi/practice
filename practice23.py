...
student5 = int(input("enter marks of student5 = "))
student6 = int(input("enter marks of student6 = "))

markslist = [ student1, student2, student3, student4, student5, student6]
sortedml = sorted(markslist)
markslist.sort()
markslist.reverse()
print(markslist)
